INVALID_EXAMPLES = [
    ...
    # Invalid
    (
        b"[[i\x01i\x02]i\x03]]"  # Extraneous closing brace
    ),
    (
        b"[#i\x03i\x01i\x02i\x03]"  # Extraneous closing brace
    ),
...
UBJSON_EXAMPLES = [
    ...
    (b"[$[#i\x02$i#i\x02\x01\x02$i#i\x01\x03", [[1, 2], [3]]),
    (b"[$[$i#i\x02#i\x02\x01\x02\x03\x04", [[1, 2], [3, 4]]),
    (b"[$[#i\x02#i\x02i\x01i\x02i\x03i\x04", [[1, 2], [3, 4]]),
    (b"[$[#i\x02[$i#i\x02\x01\x02][$i#i\x02\x03\x04]", [[[1, 2]], [[3, 4]]]),
    (b"[$[#i\x02i\x01i\x02]i\x03]", [[1, 2], [3]]),
    ...
    # Unoptimized object
    (
        b"{i\x05firstd\x3f\xc0\x00\x00i\x06secondSi\06secondi\x05thirdZ}",
        ({"first": 1.5, "second": "second", "third": None}),
    ),
    # Object with count
    (
        b"{#i\x03i\x05firstd\x3f\xc0\x00\x00i\x06secondSi\06secondi\x05thirdZ",
        ({"first": 1.5, "second": "second", "third": None}),
    ),
    ...
    (
        b"{$[$i#i\x02#i\x03i\x05first\x01\x02i\x06second\x03\x04i\x05third\x05\x06",
